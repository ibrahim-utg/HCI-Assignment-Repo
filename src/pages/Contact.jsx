    ...
    <div>
      <section className="mx-auto max-w-6xl px-5 pt-16 pb-10 md:px-8 md:pt-20">
        ...
        <p className="mt-5 max-w-2xl text-lg leading-relaxed text-ink/75">
          Whether you want to attend a seminar, host a planting day, or just ask
          a question &mdash; here's how to reach the Agro-Youth Foundation team.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-5 py-6 md:px-8">
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {channels.map(({ icon: Icon, title, value, note }) => (
            <div
              key={title}
              className="rounded-2xl border border-forest/10 bg-white/40 p-6"
            >
              ...
              <p className="mt-1 font-display text-lg font-semibold text-forest-dark">
                {value}
              </p>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
          ...
          <div>
            <SectionHeading
              ...
              title="Things people often ask us"
            />
            <div className="mt-6">
          ...
          <div>
            ...
            <form
              ...
              className="mt-6 space-y-4 rounded-2xl border border-forest/10 bg-white/40 p-6"
            >
              {sent && (
              ...
              <button
                type="submit"
                className="flex w-full items-center justify-center gap-2 rounded-full bg-forest px-5 py-3 font-body text-sm font-bold text-cream transition-colors hover:bg-forest-light"
              >
